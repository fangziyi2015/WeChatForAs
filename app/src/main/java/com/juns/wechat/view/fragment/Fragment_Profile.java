...
public class Fragment_Profile extends Fragment implements OnClickListener {
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.view_user:
			Utils.openActivity(getActivity(), MyCodeActivity.class);
			break;
		case R.id.txt_album:// 相册
			Utils.openActivity(getActivity(), PublicActivity.class,
		...
		case R.id.txt_setting:// 设置
			Utils.openActivity(getActivity(), SettingActivity.class);
			break;
		default:
			break;
		}
