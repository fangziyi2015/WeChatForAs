...
public class ShowNormalFileActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final EMFileMessageBody messageBody = getIntent().getParcelableExtra(
				"msgbody");
		...
		new Thread(new Runnable() {
			public void run() {
				EMMessage message = EMMessage.createReceiveMessage(EMMessage.Type.FILE);

				HttpFileManager fileManager = new HttpFileManager(
						ShowNormalFileActivity.this, messageBody.getLocalUrl());
